...
namespace LeXuanToan_Lab_5_2.Models
{
    ...
    {
        static readonly List<LxtCustomer> data = new List<LxtCustomer>()

        { 
    
            new LxtCustomer(){ CustomerId = "KH001",
            ...
            new LxtCustomer(){ CustomerId = "KH002",
            ...
            new LxtCustomer(){ CustomerId = "KH003",
            ...
            new LxtCustomer(){ CustomerId = "KH004",
        ...
        public IList<LxtCustomer> GetCustomers()
        ...
        public IList<LxtCustomer> SearchCustomer(string name)
        ...
        public LxtCustomer GetCustomer(string customerId)
        ...
        public void AddCustomer(LxtCustomer cus)
        ...
        public void UpdateCustomer(LxtCustomer cus)
        ...
        public void DeleteCustomer(LxtCustomer cus)
