using LeXuanToan_Lab_5_2.Models;
using System;
...
namespace LeXuanToan_Lab_5_2.Controllers
{
    public class LxtCustomerController : Controller
    {
        ...
        public ActionResult Create(LxtCustomer cus)
        ...
        public ActionResult Edit(LxtCustomer cus)
