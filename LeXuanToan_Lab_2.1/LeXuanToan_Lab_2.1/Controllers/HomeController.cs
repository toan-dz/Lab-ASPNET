using LeXuanToan_Lab_2._1.Models;
using System;
...
namespace LeXuanToan_Lab_2._1.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            string js = "function checkEMail(){var btloc=/^([w-]+(?:.[w-]+)*)@((?:[w-]+.)*w[w-]{0,66}).([a-z]{2,6}(?:.[a-z]{2})?)$/i;if(btloc.test(mail)){kq=true;}else{alert('Email address invalid');kq=false;}return kq;}";
